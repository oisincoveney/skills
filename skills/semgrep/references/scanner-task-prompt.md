# Scanner Worker Prompt

Use this prompt template for scanner workers in Step 4. Map "worker" to your harness's subagent, task, fresh session, or sequential execution mechanism.
